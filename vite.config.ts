  ...
  build: {
    ...
    rollupOptions: {
      input: {
        ...
        exQuickStart: resolve(__dirname, 'examples/quick-start.html'),
        exAstWalker: resolve(__dirname, 'examples/ast-walker.html'),
        exLiveEditor: resolve(__dirname, 'examples/live-editor.html'),
