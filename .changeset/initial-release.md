---
"@pre-markdown/core": minor
"@pre-markdown/parser": minor
"@pre-markdown/renderer": minor
"@pre-markdown/layout": minor
---

Initial release of PreMarkdown — high-performance Markdown engine powered by @chenglou/pretext zero-DOM-reflow layout.
